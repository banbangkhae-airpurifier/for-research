...
export const devicesData: Device[] = [
  ...
  new Device("Core600s", "Main Room", "fan.core_600s_series_2", "sensor.core_600s_series_2_filter_lifetime",  "sensor.core_600s_series_2_air_quality",  "sensor.core_600s_series_pm2_5"),
